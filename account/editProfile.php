...
if (isset($_GET['delete_resume']) && $_GET['delete_resume'] == 1) {
    ...
    header("Location: editProfile.php?user=" . $auth);
    exit;
}
...
<body>
    ...
    <script>
        function toggleDegreeFields() {
            ...
            document.getElementById('diploma_fields').style.display = (degreeType === 'diploma') ? 'block' : 'none';
            document.getElementById('bachelor_fields').style.display = (degreeType === 'bachelor') ? 'block' : 'none';
        }
